...
describe('SharingManager', () => {
  test('should generate and decode share data', async () => {
    ...
    expect(decoded.positive.activities.map(a => ({ ...a, createdAt: undefined, updatedAt: undefined })))
      .toEqual(mockData.positive.activities.map(a => ({ ...a, createdAt: undefined, updatedAt: undefined })))
    expect(decoded.negative.activities.map(a => ({ ...a, createdAt: undefined, updatedAt: undefined })))
      .toEqual(mockData.negative.activities.map(a => ({ ...a, createdAt: undefined, updatedAt: undefined })))
